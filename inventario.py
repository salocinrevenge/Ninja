    ...
    def render(self):
        ...
        for i in range(self.number_of_slots):
            ...
            if i == self.selected_slot:
                size_selection = 6
                pyray.draw_rectangle_rounded_lines_ex(pyray.Rectangle(x, y, slot_size, slot_size), 0.1, 1, size_selection+2, pyray.Color(0, 0, 0, self.alpha_hotbar))  # Highlight selected slot
                pyray.draw_rectangle_rounded_lines_ex(pyray.Rectangle(x, y, slot_size, slot_size), 0.1, 1, size_selection, pyray.Color(255, 255, 255, self.alpha_hotbar))  # Highlight selected slot
